...
We use [automated backports](https://github.com/julcioo/PrismLauncher-Cracked/blob/develop/.github/workflows/backport.yml) to merge specific contributions from develop into `release` branches.
